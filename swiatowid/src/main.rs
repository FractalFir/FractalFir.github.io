...
console.log(`Highlight time: ${{end - start}} ms`);
        ...
        let bluesky = "https://bsky.app/profile/fractalfir.bsky.social";
        let navigation = format!("<div class = \"nav_container\"><nav class=\"topnav\">
            ...
            <a href=\"{bluesky}\"><img src = \"../images/bluesky_media_kit_logo.svg\" class = \"bluesky_link\" height = \"27.5\" alt = \"Link to my bluesky account.\"></a>
        </nav></div>");
